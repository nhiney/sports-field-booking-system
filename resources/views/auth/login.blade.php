...
<head>
    ...
    <title>Đăng nhập - StomSport</title>
...
<body>
    ...
    <div class="login-container">
        <div class="login-art">
            <h1>Đặt sân thể thao <br> Nhanh chóng & Tiện lợi</h1>
        ...
        <div class="login-form">
            ...
            <div class="form-header">
                ...
                <p>Đăng nhập vào tài khoản <span class="gradient-text">StomSport</span> của bạn.</p>
            </div>
            ...
            <div class="text-center mt-4">
                <p>Chưa có tài khoản? <a href="{{ route('register') }}" class="form-link">Đăng ký ngay</a></p>
            </div>
        </div>
    </div>
